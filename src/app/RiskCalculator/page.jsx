...
function RiskRewardCalculator() {
  ...
  const sanitizeAndSet = (val, setter) => {
    ...
    // Remove leading zeros (unless before a decimal)
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col justify-center gap-6">
            <div className="bg-white rounded-2xl shadow-xl p-8 ring-2 ring-blue-200 text-center">
              ...
              <h2 className="text-4xl font-bold text-blue-700 mb-2">1 : {ratio}</h2>
              {ratio !== "N/A" && (
                <p className="text-md mt-2 text-gray-600">
                  For every ₹1 risked, potential gain is ₹{parseFloat(ratio).toFixed(2)}
                </p>
              )}
