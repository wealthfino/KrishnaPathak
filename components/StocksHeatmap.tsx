...
const StocksHeatmap = () => {
  ...
  return (
    <div className="w-[95vw ] flex justify-center items-center px-4 md:px-8 lg:px-10 py-4 sm:py-6 md:py-8 lg:py-10 xl:py-12 ">
        ...
        <motion.div {...motionProps} className="w-[95vw] max-w-[100vw]">
          ...
          <BackgroundGradient className="w-full h-full flex justify-center items-center mx-auto">
            <div className="bg-[#0f1117] rounded-[20px] w-full h-full flex flex-col justify-between gap-10 items-center p-4 sm:p-5 md:p-8">
              ...
              <div className="bg-gradient-to-tl from-[#1f2b5e] via-[#13B5E8] to-[#7ac678] rounded-xl shadow-lg h-[500px] lg:h-[600px] w-[90vw] p-[6px] ">
